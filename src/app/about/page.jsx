export default function About() {
  return (
    <main>
      <h1 className="text-3xl font-bold mb-4">About — Avhishikta Maiti</h1>
      <p className="text-slate-550">Hello! I’m Avhishikta Maiti, a passionate Computer Applications student pursuing my Bachelor of Computer Application (BCA) from Midnapore College (Autonomous), affiliated with Vidyasagar University. I have a strong interest in web development, Python programming, and building real-world digital solutions.
        <br /> <br />
