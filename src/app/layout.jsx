...
export const metadata = {
  title: 'Avhishikta Maiti — Portfolio',
  description: 'Portfolio of Avhishikta Maiti',
}
        ...
        <div id="top" className="container py-12">
          <nav className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-3">
              <img src="/avatar.jpeg" alt="Avhishikta Maiti" className="w-10 h-10 rounded-full shadow-md" />
              <Link href="/" className="text-xl font-semibold">Avhishikta Maiti</Link>
            </div>
          ...
          <footer className="mt-16 border-t border-slate-200 dark:border-slate-700 pt-8 text-sm text-slate-600 dark:text-slate-400">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div>
                <Link href="/" className="flex items-center gap-3">
                  <img src="/avatar.jpeg" alt="Avhishikta Maiti" className="w-9 h-9 rounded-full shadow-sm" />
                  <span className="font-semibold">Avhishikta Maiti</span>
                </Link>
              ...
              <div className="flex gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    <li><a href="mailto:avhishiktamaiti@gmail.com" className="hover:text-sky-600">avhishiktamaiti@gmail.com</a></li>
                    {/* <li><a href="https://wa.me/number" target="_blank" rel="noreferrer" className="hover:text-sky-600">WhatsApp</a></li> */}
                    <li><a href="https://www.linkedin.com/in/avhishikta-maiti-249ab5303/" target="_blank" rel="noreferrer" className="hover:text-sky-600">LinkedIn</a></li>
                    <li><a href="https://github.com/Avhishikta" target="_blank" rel="noreferrer" className="hover:text-sky-600">GitHub</a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
              <span>© {new Date().getFullYear()} Avhishikta Maiti. All rights reserved.</span>
